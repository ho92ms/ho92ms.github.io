...
### Systems Engineering
- Enterprise IT infrastructure (Windows, Linux)
- Cloud platforms (Azure) and virtualization
- Endpoint management, security, and compliance
- DevOps practices and automation

### Software Development
- Backend systems and RESTful services
...
- Data analysis and statistical modeling in Python

---

## Approach

I am particularly interested in problems where **theoretical structure meets practical constraints**, such as:

- Designing machine learning systems that are both **interpretable** and **high-performing**.
- Building software architectures that balance **flexibility** with **formal guarantees**.
- Applying **mathematical principles** to real-world engineering challenges.
